      ...
      {sections
        ...
        .map(({ category }) => (
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-charcoal-700 bg-charcoal-850 px-4 py-2 text-sm font-medium text-cream-100 transition-all hover:border-flame-500 hover:bg-charcoal-700 hover:text-flame-600"
          >
